...
public class MatchTestsFIVE {
    ...
    public void createMatch(){
        ...
        match=new TennisMatch(player1, player2, MatchType.BEST_OF_FIVE, false);
    }

    @Test
    public void matchInfos(){
        assertEquals(match.getMatchType(),MatchType.BEST_OF_FIVE);
    }
    ...
    public void WinMatch(){
        ...
        assertEquals(5,match.getNbSetsWin(player1));
    }
    ...
    public void MockMatch() {
        ...
        for(int i=0; i<2;i++){
            ...
            match.updateWithPointWonBy(player2); //40
            match.updateWithPointWonBy(player2); //W
            assertEquals(1+i, match.getNbSetsWin(player2));
        ...
        assertEquals(2, match.getNbSetsWin(player2));
        assertEquals(0, match.gamesInCurrentSetForPlayer(player1));
        assertEquals(0, match.gamesInCurrentSetForPlayer(player2));
    }
